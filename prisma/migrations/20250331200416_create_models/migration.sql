...
CREATE TABLE "DealerShip" (
    ...
    "address" TEXT NOT NULL DEFAULT '69 car Strett Autovill2,CA 97888A',
    "phone" TEXT NOT NULL DEFAULT '+1 (555) 123-456',
    "email" TEXT NOT NULL DEFAULT 'akshay@gamail.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "WorkingHour" ADD CONSTRAINT "WorkingHour_dealershipId_fkey" FOREIGN KEY ("dealershipId") REFERENCES "DealerShip"("id") ON DELETE CASCADE ON UPDATE CASCADE;
